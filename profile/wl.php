...
<br/><br/>
    ...
    &nbsp  &nbsp  &nbsp  &nbsp  &nbsp  &nbsp  &nbsp </h1></div>
        ...
        <table style="width:100%;border:1px solid black;border-collapse:collapse;">
            ...
            <td class="home" style="border-right:1px solid black;"><a href="index.php">&nbsp  HOME &nbsp</a></td>
            <td class="home" style="border-right:1px solid black;font-size:18px;">
                <a href="../search/index.php"> SEARCH MOVIES FROM omdb</a>
            </td>
...
<section>
    ...
    <?php 
    $stmt="SELECT DISTINCT imdbid,movname,poster FROM watchlater WHERE user_uid = '$uid'";
    $result=mysqli_query($con,$stmt);
    $resultCheck = mysqli_num_rows($result);

    if($resultCheck>0){
        echo "<h2>!.. WANT TO WATCH ..!</h2>";
    $sql=$con->prepare("SELECT DISTINCT imdbid,movname,poster FROM watchlater WHERE user_uid = '$uid'");
    $sql->execute();
